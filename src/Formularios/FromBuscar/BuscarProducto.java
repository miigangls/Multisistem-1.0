...
public class BuscarProducto extends javax.swing.JFrame {
    ...
    private void  Cargar_Nombre ()
  {
        ...
        ArrayList <MetProducto> ListaEntrevista  = new ArrayList();
        ListaEntrevista = OBJ.CargarNombre();
            int i = 0 ;
            for ( MetProducto A:ListaEntrevista) 
            {
                Com_Nombres .addItem(A.getNombreProducto());
             i++;
            }
    ...
    private void  Buscar_Nombre()
  {
      ...
      MetProducto obj = new MetProducto();
        ...
        ListaBuscarCedula = obj.Buscar_ProductoNombre(String.valueOf(Com_Nombres.getSelectedItem()));
        VariablesGlobales Var = new VariablesGlobales();
       if (obj.getI() == 0) {
         for ( MetProducto A:ListaBuscarCedula) 
            {
                Var.setNombreProducto(A.getNombreProducto());
                Var.setCodiBarrasProducto(String.valueOf(A.getCodiBarrasProducto()));
                Var.setTipoProducto(A.getTipoProducto());
                Var.setMarcaProducto(String.valueOf(A.getMarcaProducto()));
                Var.setCategoriaProducto(A.getCategoriaProducto());
                Var .setSerieProducto(A.getSerieProducto());
                Var.setPrecioProducto (A.getPrecioProducto());
                Var .setStockProducto(A.getStockProducto());        
            } 
    ...
    private void initComponents() {
        ...
        JPanel_Postulacione.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Buscar Producto", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.BELOW_TOP, new java.awt.Font("Euphemia", 0, 18), java.awt.Color.white)); // NOI18N
        ...
        jcMousePanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jcMousePanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(JPanel_Postulacione, javax.swing.GroupLayout.DEFAULT_SIZE, 491, Short.MAX_VALUE)
                .addContainerGap())
        );
